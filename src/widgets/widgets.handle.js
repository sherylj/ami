...
export default class WidgetsHandle extends WidgetsBase {
  ...
  onMove(evt) {
    ...
    this._mouse.set(((evt.offsetX - this._container.offsetLeft)/ this._container.clientWidth) * 2 - 1,
                    -((evt.offsetY - this._container.offsetTop) / this._container.clientHeight) * 2 + 1);
